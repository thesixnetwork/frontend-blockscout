...
```typescript
const RWA_NOTE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS || '0xb164761a3a0402ad291FC416036e9803ca19B37A';
```
...
```bash
NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS=0xb164761a3a0402ad291FC416036e9803ca19B37A
```
