...
```typescript
const RWA_NOTE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS || '0x7767d7bc3bA67Dc50593572296B948474B9aF2c0';
```
...
```bash
NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS=0x7767d7bc3bA67Dc50593572296B948474B9aF2c0
```
