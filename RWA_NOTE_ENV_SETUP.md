...
```typescript
const RWA_NOTE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS || '0xc1C9B017F845D3BaE85f9231DD88a908a560B456';
```
...
```bash
NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS=0xc1C9B017F845D3BaE85f9231DD88a908a560B456
```
