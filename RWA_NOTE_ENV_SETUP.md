...
```typescript
const RWA_NOTE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS || '0x01824B8F5cC22Cab69B611C2b9Dee53494C368c6';
```
...
```bash
NEXT_PUBLIC_RWA_NOTE_CONTRACT_ADDRESS=0x867AA9D2885081849d6a08b3db67574975B7D7D7
```
